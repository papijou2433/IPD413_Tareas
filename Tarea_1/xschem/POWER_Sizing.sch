...
"}
C {devices/code.sym} -1110 -180 0 0 {name=DC_sweep_simulation only_toplevel=false 
value="
.save all
...
descr="Vov="}
C {code.sym} -1110 -330 0 0 {name=POWER_MOS_Param only_toplevel=false spice_ignore=0
