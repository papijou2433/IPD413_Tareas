...
"}
C {DCDC_Buck.sym} -630 -220 0 0 {name=X1v \{xschem version=3.4.5 file_version=1.2
\}
G \{\}
K \{type=subcircuit
...
L 4 -10 10 -10 20 \{\}
L 4 80 -20 90 -20 \{\}
B 5 -102.5 -42.5 -97.5 -37.5 \{name=VgM1
dir=in\}
B 5 -102.5 -2.5 -97.5 2.5 \{name=VgM2
dir=in\}
B 5 -12.5 17.5 -7.5 22.5 \{name=GND
dir=inout\}
B 5 -12.5 -62.5 -7.5 -57.5 \{name=Vin
dir=inout\}
B 5 87.5 -22.5 92.5 -17.5 \{name=Vo
dir=inout\}
T \{VgM1\} -88 -43 0 0 0.2 0.2 \{\}
T \{VgM2\} -88 -8 0 0 0.2 0.2 \{\}
T \{Vin\} -19 -49 0 0 0.2 0.2 \{\}
T \{@symname\} -52 -25 0 0 0.25 0.25 \{\}
T \{@name\} 29 -64 0 0 0.25 0.25 \{\}
T \{GND\} -19 -4 0 0 0.2 0.2 \{\}
T \{Vo\} 61 -25 0 0 0.2 0.2 \{\}
}
C {code.sym} -1240 -310 0 0 {name=POWER_MOS_Param only_toplevel=false spice_ignore=0
